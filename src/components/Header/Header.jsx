...
const menuArray = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "계약안내문", subUrl: "/SalesInfo/guide" },
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "시스템", subUrl: "/ComplexGuide/community" },
    ],
  },
  {
    title: "세대안내",
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu((v) => !v)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#252b5d" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#252b5d" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#252b5d" />
          </a>
        </div>
        {isInterestPopupOpen && (
          <InterestPopup
