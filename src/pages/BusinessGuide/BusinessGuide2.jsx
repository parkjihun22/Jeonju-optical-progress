...
<Helmet>
  ...
  <meta
    name="description"
    content="북전주 광신프로그레스 분양일정 안내. 전북특별자치도 전주시 덕진구 고랑동 742번지 일원 북전주 광신프로그레스의 특별공급, 일반공급, 당첨자 발표, 계약일정 등 주요 분양 일정을 확인하세요."
  />

  <meta
    name="keywords"
    content="북전주 광신프로그레스, 북전주 광신프로그레스 분양일정, 전주 광신프로그레스, 전주 아파트 분양일정, 전주 청약, 전주 덕진구 아파트, 고랑동 아파트, 전주 신축 아파트, 광신프로그레스, 광신종합건설"
  />
...
<p className={styles.screenReaderOnly}>
  ...
  북전주 광신프로그레스의 특별공급, 일반공급, 당첨자 발표,
  계약일정 등 주요 청약 일정을 확인할 수 있습니다.
  북전주 광신프로그레스 분양일정과 청약 정보를 빠르게 확인해 보세요.
</p>

<div className={styles.textBox}>
  <div>북전주의 새로운 주거 가치를 만나보세요</div>
