...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        <title>북전주 광신프로그레스 - 체크포인트</title>
        <meta
          name="description"
          content="북전주 광신프로그레스 청약 전 필수 체크포인트를 확인하세요. 청약 자격(거주기간·무주택·예치금), 특별공급 유형, 필요서류, 접수 일정 및 유의사항을 안내합니다."
        />
      ...
      <p className={styles.screenReaderOnly}>
        북전주 광신프로그레스 청약 전 반드시 확인해야 할 체크포인트입니다.
