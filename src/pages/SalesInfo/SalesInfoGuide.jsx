...
<div className={styles.container}>
  ...
  <p className={styles.screenReaderOnly}>
    북전주 광신프로그레스 계약안내 페이지입니다.
    당첨자 계약 절차와 계약 일정, 계약 시 필요서류,
    계약금 납부 방법 및 유의사항을 확인하고 공식 기준에 맞춰 준비하세요.
  </p>

  <div className={styles.textBox}>
    <div>계약 절차와 필요서류를 확인하세요</div>
    <div>북전주 광신프로그레스 계약안내</div>
  </div>
