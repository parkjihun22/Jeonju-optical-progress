...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망 프리미엄`,
    text2: `전주IC·호남고속도로·동부대로를 통한 광역 교통망<br/>
            편리한 이동을 누리는 북전주 광신프로그레스`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `풍부한 생활 인프라`,
    text2: `에코시티·만성지구 생활권과<br/>
            더욱 편리한 일상을 누리는 프리미엄 주거 환경`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `탄소소재 국가산단 미래가치`,
    text2: `탄소소재 스마트그린 국가산업단지 인접 입지<br/>
            미래가치를 더하는 북전주 프리미엄 라이프`,
...
<div className={styles.imageContainer}>
  ...
  <div className={styles.mainImageTextBox}>
    ...
    <div className={styles.mainImageTextSub}>
      북전주가 선택한{" "}
      <span className={styles.greyText}>새로운 프리미엄 라이프</span>
    </div>
    ...
    <div className={styles.mainImageTitleBox}>
      ...
      <div className={styles.mainImageDesc}>
        전주 북부권의 미래가치를 품은 프리미엄 주거단지<br />
        탄소소재 스마트그린 국가산업단지와 함께하는 미래 비전<br />
        북전주 광신프로그레스가 제안하는 새로운 라이프스타일
      </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 전주 북부권의 새로운 주거 중심 입지 프리미엄<br />
                  - 탄소소재 스마트그린 국가산업단지 인접 미래가치<br />
                  - 전주IC·호남고속도로·동부대로를 통한 편리한 광역 교통망<br />
                  - 에코시티·만성지구 생활권과 풍부한 생활 인프라를 누리는 프리미엄 입지<br />
                  - 전용 84㎡ 중심 설계와 쾌적한 커뮤니티를 갖춘 브랜드 아파트
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="북전주 광신프로그레스브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>북전주 광신프로그레스</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mykavrqa"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="북전주 광신프로그레스오시는길안내-image1" />
            </div>
          </div> */}
  ...
  <img
    src={mobileImageMain}
    className={styles.mainImage}
    alt="북전주 광신프로그레스 아파트 모바일 메인 이미지"
  />
  ...
  <div className={styles.mainImageTextBox1}>
    ...
    <div className={styles.mainImageTitleBox1}>
      ...
      <div className={styles.mainImageDesc1}>
        전주 북부권에서 누리는 브랜드 프리미엄<br />
        탄소소재 스마트그린 국가산업단지와 함께하는 미래가치<br />
        북전주 광신프로그레스가 제안하는 새로운 라이프스타일
      </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 북전주 광신프로그레스에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="북전주 광신프로그레스모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="북전주 광신프로그레스브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="북전주 광신프로그레스오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
